...
export const districtScenes: Record<DistrictId, DistrictScene> = {
  ...
  'two-harmonic': {
    id: 'two-harmonic',
    name: '2 Harmonic',
    eyebrow: 'Beige Frequency · Fashion House',
    description: 'A monumental desert atelier of cream stone, black glass, moving fabric, museum light, and garments displayed like living sculptures.',
    href: '/worlds/two-harmonic/collections',
    accent: '#f0cf91',
    accentSoft: 'rgba(240,207,145,.24)',
    skyTop: '#2b211b',
    skyBottom: '#a27a52',
    fog: 'rgba(245,218,170,.2)',
    architecture: 'fashion',
    primaryAction: 'Enter showroom',
    secondaryAction: { label: 'Melody Sync', href: '/worlds/two-harmonic/melody-sync' },
    landmarks: ['Runway Hall', 'Garment Vault', 'Melody Gallery', 'Private Release Room'],
  },
  'fried-em': {
    id: 'fried-em',
    name: 'Fried Em',

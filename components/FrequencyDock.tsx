...
export function FrequencyDock() {
  return (
    <nav className="fixed bottom-4 left-1/2 z-50 w-[calc(100%-24px)] max-w-3xl -translate-x-1/2 rounded-full border border-white/15 bg-black/45 px-3 py-3 shadow-purple-glow backdrop-blur-2xl">

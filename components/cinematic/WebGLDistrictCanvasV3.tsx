  ...
  useEffect(() => {
    ...
    districtModelAssets[district].forEach((asset) => {
      loader.load(asset.url, (gltf) => {
        ...
        clone.position.set(...asset.position);

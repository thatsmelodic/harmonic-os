      ...
      <section className="harmonic-container py-8 sm:py-12">
        <nav className="mb-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/worlds/schmackinn/map" className="rounded-full bg-purple-300 px-4 py-3 text-sm font-black text-black transition hover:bg-purple-200">Flavor City</Link>
            <Link href="/worlds/schmackinn/callouts" className="rounded-full border border-purple-200/20 bg-purple-300/10 px-4 py-3 text-sm font-black text-purple-100">📣 Callouts</Link>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div className="glass-panel schmackinn-panel rounded-[2.5rem] p-6 sm:p-10">
            ...
            <p className="mt-6 max-w-2xl text-xl font-black leading-tight tracking-[-.04em] text-white/88 sm:text-3xl">Schmackinn is a living food city where every review becomes a storefront, a frequency, a memory, and a community event.</p>
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/64 sm:text-lg">Explore real districts, enter living restaurants, experience the first bite, call out the next spot, and preserve every meal that meant something.</p>

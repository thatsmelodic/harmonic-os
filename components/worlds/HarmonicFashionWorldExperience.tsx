      ...
      <section className="harmonic-container py-8 sm:py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div className="glass-panel rounded-[2.5rem] p-6 sm:p-10">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/64 sm:text-lg">The runtime listener now lets Harmonic react to live Mission Control signals.</p>
          ...
          <aside className="glass-panel rounded-[2.5rem] p-6 sm:p-8">
            <div className="mb-6 flex items-center justify-between"><p className="text-xs font-black uppercase tracking-[.34em] text-white/40">Design Kernel</p><span className="rounded-full border border-[#f5dfb8]/20 px-3 py-1 font-mono text-xs text-[#f5dfb8]/60">RUNTIME LIVE</span></div>

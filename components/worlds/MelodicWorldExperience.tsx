        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          ...
          <aside className="glass-panel rounded-[2.5rem] p-6 sm:p-8">
            <div className="mb-6 flex items-center justify-between">
              ...
              <span className="rounded-full border border-purple-200/20 px-3 py-1 font-mono text-xs text-purple-100/55">OS NODE</span>
            </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[.9fr_1.1fr]">
          <div className="glass-panel rounded-[2rem] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-white/62">
              The next version of this world will connect each song to lyrics, moods, visuals, rollout notes, cover art, production status, and the life moment that created it.
            </p>
          </div>

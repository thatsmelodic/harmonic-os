      ...
      <section className="harmonic-container py-8 sm:py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div className="glass-panel fried-panel rounded-[2.5rem] p-6 sm:p-10">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/64 sm:text-lg">The Living World Engine now controls crowd, arena lights, camera behavior, audio layers, event mode, and highlight ripples.</p>
          ...
          <aside className="scoreboard rounded-[2.5rem] border border-orange-200/15 bg-black/55 p-6 shadow-[0_0_60px_rgba(255,122,26,.20)] backdrop-blur-2xl sm:p-8">
            <div className="mb-6 flex items-center justify-between"><p className="text-xs font-black uppercase tracking-[.34em] text-white/40">Arena Runtime</p><span className="rounded-full border border-orange-200/20 px-3 py-1 font-mono text-xs text-orange-200/60">LIVING</span></div>
